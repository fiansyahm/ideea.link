...
{{-- https://jagoketik.com/jasa-input-data/ --}}
                    ...
                    <div class="col">
                        <div class="inner-content">
                            ...
                            <div class="button-container">
                                ...
                                <a href="#price" class="btn btn-primary" type="button">LIHAT HARGA</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <h1 class="text-center mt-5">Kenapa Input Data di IDEEA.LINK</h1>
            <p class="text-center light-gray-color">Tidak hanya satu atau dua orang saja yang siap bekerja untuk input data,
                di ideea.link tersedia hingga puluhan Jagoan Ketik Profesional yang selalu siap membantumu 24/7 hari. Ini
        ...
        <div class="container">
            <h1 id="price" class="text-center mt-5">Harga Jasa Input Data (Data Entry)</h1>
            <p class="text-center light-gray-color">Berapa harga jasa input data (data entry)? Berikut ideea.link
                tawarkan
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary text-white">Rp250/cell</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary text-white">Rp750/cell</a>
                        </div>
                    </div>
                </div>
            </div>
