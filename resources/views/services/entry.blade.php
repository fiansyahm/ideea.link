    ...
    <body>
        ...
        <div class="container">
            ...
            <ol class="list-group list-group-numbered">
                <li class="list-group-item">Tersedia 24/7 hari tanpa libur;</li>
                <li class="list-group-item">Siap membantu input data hingga ribuan atau bahkan jutaan data sekaligus;</li>
                <li class="list-group-item">Dapat melakukan pelbagai jenis input data, seperti: Excel (spreadsheet), website, produk di marketiplace, formulir, tabulasi, dan lain sebagainya;</li>
              </ol>
        </div>
