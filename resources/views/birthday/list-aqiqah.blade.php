...
@section('main')
   ...
   <div class="container text-center">
       ...
       @if (session('status'))
        ...
        @endif
       <img src="https://media.istockphoto.com/id/1167132635/vector/wedding-invitation-with-flowers-peony-and-leaves-watercolor-isolated-on-white.jpg?s=612x612&w=0&k=20&c=_S2rSkpLJOKwILtPDBf-NiU9WFJ3ebyugXPuZibk63Q=" class="img-fluid my-5" alt="aqiqah-icon">
        <form id="aqiqah-icon">
          <div class="mb-3">
            <label for="link" class="form-label">Click copy link undangan anda disini. Dan share ke teman teman anda</label>
            <input class="form-control text-center" type="text" value="https://akad.in/invitation-aqiqah/{{$aqiqah->id}}/namatamu" id="myInput">
          </div>
        ...
        <form id="aqiqah-icon">
          <div class="mb-3">
            ...
            <input class="form-control text-center" type="text" value="https://akad.in/list-guest-aqiqah/{{$aqiqah->id}}" id="myConfrimation">
          </div>
