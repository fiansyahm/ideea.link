       ...
       <img src="https://media.istockphoto.com/id/1167132635/vector/wedding-invitation-with-flowers-peony-and-leaves-watercolor-isolated-on-white.jpg?s=612x612&w=0&k=20&c=_S2rSkpLJOKwILtPDBf-NiU9WFJ3ebyugXPuZibk63Q=" class="img-fluid my-5" alt="wedding-icon">
        <form id="wedding-icon">
          <div class="mb-3">
            ...
            <input class="form-control text-center" type="text" value="https://akad.in/invitation-khitan/{{$wedding->id}}/namatamu" id="myInput">
          </div>
        ...
        <form id="wedding-icon">
          <div class="mb-3">
            ...
            <input class="form-control text-center" type="text" value="https://akad.in/list-guest-khitan/{{$wedding->id}}" id="myConfrimation">
          </div>
