...
@section('main')
    ...
    <div class="mx-3 mt-5 rounded" style="color: white;background-image: url(https://marketplace.canva.com/EAFNFlMpIKw/1/0/1600w/canva-pink-watercolor-linktree-background-CJpXvOkftQY.jpg);">
        <h1 class="text-center">Edit Aqiqah Invitation</h1>
        <form enctype="multipart/form-data" class="mx-5 mb-5 pb-5" class="ps-checkout__form" action="/update-aqiqah" method="post">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('id') is-invalid @enderror" id="id"
                            name="id" value="{{ $aqiqah['id'] }}" placeholder="ID Undangan">
                        @error('id')
            ...
            <div class="row">
                <div class="col-md-5 text-white mb-5 card" style="background-image: url('https://i.ibb.co/NS92FLH/foto-laki2.jpg');">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nickname') is-invalid @enderror" id="nickname" name="nickname" value="{{ $aqiqah->nickname }}" placeholder="ADI">
                    @error('nickname')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('fullname') is-invalid @enderror" id="fullname" name="fullname" value="{{ $aqiqah->fullname }}" placeholder="Adi Firmansyah">
                    @error('fullname')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('child') is-invalid @enderror" id="child" name="child" value="{{ $aqiqah->child }}" placeholder="Kedua">
                    @error('child')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('fathername') is-invalid @enderror" id="fathername" name="fathername" value="{{ $aqiqah->fathername }}" placeholder="Bapak Dwi Darmono">
                    @error('fathername')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('mothername') is-invalid @enderror" id="mothername" name="mothername" value="{{ $aqiqah->mothername }}" placeholder="Ibu Ningsih Rukmini">
                    @error('mothername')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="photo" name="photo"  value="{{ $aqiqah->photo }}" placeholder="https://i.ibb.co/NS92FLH/foto-laki2.jpg (boleh dikosongi)">
                  </div>
                  <div class="mb-3">
                    <label for="instagram" class="form-label">Username instagram</label>
                    <input type="text" class="form-control" id="instagram" name="instagram" value="{{ $aqiqah->instagram }}" placeholder="cristiano">
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  <div class="bg-info text-white mb-5 card" style="background-image: url('https://media.istockphoto.com/id/1480712755/id/foto/defokus-glitter-hijau-emas-bokeh-abstrak-background-dengan-lampu-bokeh-lampu-vintage.jpg?s=612x612&w=0&k=20&c=tJDwioqTTDFwd6h64WQn4kcTAIcIRKd8jE36GdgaC40=');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
                      <div class="mb-3 text-center">
                        ...
                        <input class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ $aqiqah->date }}" type="date" />
                        @error('date')
                          <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="row">
                          <div class="col-md-6">
                              <div class="mb-3 text-center mx-2">
                                ...
                                <input class="form-control @error('hourStart') is-invalid @enderror" id="hourStart" name="hourStart" value="{{ $aqiqah->hourStart }}" type="time" />
                                @error('hourStart')
                                  <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                              </div>
                          ...
                          <div class="col-md-6">
                              <div class="mb-3 text-center mx-2">
                                ...
                                <input class="form-control @error('hourEnd') is-invalid @enderror" id="hourEnd" name="hourEnd"value="{{ $aqiqah->hourEnd }}" type="time" />
                                @error('hourEnd')
                                  <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                              </div>
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div class="mb-3 text-center mx-2">
                                ...
                                <input type="text" class="form-control @error('placeName') is-invalid @enderror" id="placeName" name="placeName" value="{{ $aqiqah->placeName }}" placeholder="Ballroom Kamboja, My Tower Hotel Surabaya">
                                @error('placeName')
                                  <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                              </div>
                          ...
                          <div class="col-md-6">
                              <div class="mb-3 text-center mx-2">
                                ...
                                <input type="text" class="form-control @error('placeAddress') is-invalid @enderror" id="placeAddress" name="placeAddress" value="{{ $aqiqah->placeAddress }}" placeholder="Jl. Rungkut Industri Raya No.4, Kutisari, Kec. Tenggilis Mejoyo, Kota SBY, Jawa Timur">
                                @error('placeAddress')
                                  <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                              </div>
                          ...
                          <div class="col-md-6">
                              <div class="mb-3 text-center mx-2">
                                ...
                                <input type="text" class="form-control @error('googleAddress') is-invalid @enderror" id="googleAddress" name="googleAddress" value="{{ $aqiqah->googleAddress }}" placeholder="https://maps.app.goo.gl/pKsatZc8hMRwpiUHA">
                                @error('googleAddress')
                                  <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                              </div>
              ...
              <div class="col-md-6">
                  <div class="bg-info text-white mb-5 card" style="background-image: url('https://www.harianinhuaonline.com/wp-content/uploads/2018/02/fireinthesky-lanternfestival-home-1.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
                    ...
                    <div class="mb-3 text-center mx-2">
                      ...
                      <input type="text" class="form-control" id="bank" name="bank" value="{{ $aqiqah->bank }}" placeholder="BRI">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      <label for="account-name" class="form-label">Nama Pemilik Rekening Pertama</label>
                      <input type="text" class="form-control" id="accountName" name="accountName" value="{{ $aqiqah->accountName }}" placeholder="Fira Permata">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      <label for="account-number" class="form-label">Rekening Pertama</label>
                      <input type="text" class="form-control" id="accountNumber" name="accountNumber" value="{{ $aqiqah->accountNumber }}" placeholder="86093939393">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      <label for="bank2" class="form-label">Nama Bank Kedua</label>
                      <input type="text" class="form-control" id="bank2" name="bank2" 
                          value="{{ $aqiqah->bank2 }}" placeholder="BCA">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      ...
                      <input type="text" class="form-control" id="accountName2" name="accountName2"
                          value="{{ $aqiqah->accountName2 }}" placeholder="Adi Firmansyah">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      ...
                      <input type="text" class="form-control" id="accountNumber2" name="accountNumber2"
                          value="{{ $aqiqah->accountNumber2 }}" placeholder="043185737">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      <label for="gift-address" class="form-label">Alamat Kirim Kado </label>
                      <input type="text" class="form-control" id="giftAddress" name="giftAddress" value="{{ $aqiqah->giftAddress }}" placeholder="Jl. Rungkut Industri Raya No.4, Kutisari, Kec. Tenggilis Mejoyo, Kota SBY, Jawa Timur">
                    </div>
                    <div class="mb-3 text-center mx-2">
                      ...
                      <select id="congratulations" name="congratulations" class="form-select"
                          ...
                          @if ($aqiqah->congratulations != null)
                              <option value="{{ $aqiqah->congratulations }}" selected>
                                  {{ $aqiqah->congratulations }}</option>
                          @endif
                ...
                <div class="bg-info text-white mb-5 card"
                    ...
                    <div class="mb-3 text-center mx-2">
                        ...
                        <select id="theme" name="theme" class="form-select"
                            aria-label="Default select example">
                            @if ($aqiqah->theme != null)
                                <option value="{{ $aqiqah->theme }}" selected>{{ $aqiqah->theme }}</option>
                            @endif
                    ...
                    <div class="mb-3 text-center mx-2">
                        ...
                        <select id="music" onchange="play()" name="music" class="form-select"
                            aria-label="Default select example">
                            @if ($aqiqah->music != null)
                                <option value="{{ $aqiqah->music }}" selected>{{ $aqiqah->music }}</option>
                            @endif
                    ...
                    <div class="mb-3 text-center mx-2">
                        ...
                        <select id="timezone" name="timezone" class="form-select" aria-label="Default select example">
                            @if ($aqiqah->timezone != null)
                                <option value="{{ $aqiqah->timezone }}" selected>{{ $aqiqah->timezone }}</option>
                            @endif
