                    ...
                    <div class="col-md-4">
                        <div class="card-body text-center m-0 p-0">
                            ...
                            <div class="mb-5 mt-0 p-0" id="family-profil-1" style="display: none">
                                <p class="m-0 p-0" style="font-size:14px;font-weight:bold">Putra {{$wedding->childFemale}}</p>
                    ...
                    <div class="col-md-4">
                        <div class="card-body text-center">
                            ...
                            <div class="mb-5 mt-0 p-0" id="family-profil-2" style="display:none">
                                <p class="m-0 p-0" style="font-size:14px;font-weight:bold">Putri {{$wedding->childMale}}</p>
