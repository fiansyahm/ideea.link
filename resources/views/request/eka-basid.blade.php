    ...
    <div class="top m-0 text-white">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <h1 id="initial-icon" style="color:white;" class="navbar-brand">{{$wedding->nicknameMale[0]}} & {{$wedding->nicknameFemale[0]}}</h1>
    ...
    <div style="display:none" id="content-of-main">
        ...
        <div id="ayat" class="quote-1 p-3" style="display:none;">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a data-fancybox="gallery" href="{{$wedding->photoFemale}}">
                                    <img id="foto-profil-1" style="display: none;" class="card-img-top img-fluid" src="{{$wedding->photoFemale}}" alt="..." />
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body m-0 p-0 pt-5">
                ...
                <h2 class="card-subtitle fw-bold" id="fullname-profil-1" style="display: none;font-size: 20px">{{$wedding->fullnameFemale}}</h2>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a data-fancybox="gallery" href="{{$wedding->photoMale}}">
                                    <img id="foto-profil-2" style="display: none" class="card-img-top img-fluid" src="{{$wedding->photoMale}}" alt="... " />
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body m-0 p-0 pt-5 text-end">
                ...
                <h2 class="card-subtitle fw-bold" id="fullname-profil-2" style="display: none;font-size: 20px">{{$wedding->fullnameMale}}</h2>
        ...
        <div class="m-0 p-0">
            <div class="text-center m-0 py-5" id="special-thanks">
                ...
                <p style="font-size: 15px;">{{$wedding->fathernameFemale}}  &  {{$wedding->mothernameFemale}}</p>
                <p class="m-0 p-0" style="font-size: 15px;">{{$wedding->fathernameMale}}  &  {{$wedding->mothernameMale}}</p> 
            </div>
