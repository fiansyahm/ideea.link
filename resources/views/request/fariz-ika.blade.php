        ...
        <div class="text-center m-0 p-0" id="gift">
            ...
            <div class="container" >
                ...
                <div class="row">
                    ...
                    <div id="transfer-rekening" class="col-sm-6">
                        <h2 class="m-0 p-0" style="font-size: 30px">Transfer ke Rekening BRI</h2>
                        <p class="m-0 p-0 my-2"><img  height="100" width="200" src="https://www.gultomlawconsultants.com/wp-content/uploads/2014/08/Pengertian-Bank-dan-Jenis-Jenis-Usaha-Bank.jpg" alt="Bank logo"></p>
                        <p class="m-0 p-0" style="font-size:20px">a.n Tiwik Ismawati</p>
                        <p class="m-0 p-0" style="font-size:20px">644001022588531</p>
                        <button type="button" class="btn btn-secondary mb-5" onclick="myFunction('{{$wedding->accountNumber}}')">Copy No. Rekening</button>
                    </div>
                    <div id="transfer-rekening" class="col-sm-6">
                        <h2 class="m-0 p-0" style="font-size: 30px">Transfer ke Rekening BANK JATIM</h2>
                        <p class="m-0 p-0 my-2"><img  height="100" width="200" src="https://www.gultomlawconsultants.com/wp-content/uploads/2014/08/Pengertian-Bank-dan-Jenis-Jenis-Usaha-Bank.jpg" alt="Bank logo"></p>
                        <p class="m-0 p-0" style="font-size:20px">a.n Nita Kusyoko</p>
                        <p class="m-0 p-0" style="font-size:20px">0102528689</p>
                        <button type="button" class="btn btn-secondary mb-5" onclick="myFunction('{{$wedding->accountNumber}}')">Copy No. Rekening</button>
                    </div>
