...
<head>
    ...
    <title>{{$wedding->nicknameFemale}} & {{$wedding->nicknameMale}} Wedding</title>
    <!-- cdn jquery -->
    ...
    <style>
        ...
        /* 1 */
        .top {
            background: url("{{$image_themes[1]}}") no-repeat center center;
        ...
        /* 2 */
        #ayat{
            background: url("{{$image_themes[2]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 3 */
        #date_time {
            background: url("{{$image_themes[3]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 4 */
        #akad-resepsi{
            background: url("{{$image_themes[4]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 5 */
        #prewed{
            background: url("{{$image_themes[5]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 6 */
        #ucapan-doa{
            background: url("{{$image_themes[6]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 7 */
        #gift{
            background: url("{{$image_themes[7]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
        ...
        /* 8 */
        #special-thanks{
            background: url("{{$image_themes[8]}}") no-repeat center center;
            background-size: cover;
            /* height: 1300px; */
        }
    ...
    <div style="display:none" id="content-of-main">
                ...
                <div class="row">
                    <div class="col-md-4  m-0 p-0">
                        <div class="card text-center shadow-lg bg-body-tertiary rounded">
                            ...
                            <img id="foto-profil-1" style="display: none;" class="card-img-top img-fluid p-3 pb-5" src="{{$wedding->photoFemale}}" alt="..." />
                            </a>    
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card-body text-center m-0 p-0">
                            <h1 class="card-title text-secondary" id="nickname-profil-1" style="display: none;font-size: 40px;">{{$wedding->nicknameFemale}}</h1>
                            <h2 class="card-subtitle fw-bold" id="fullname-profil-1" style="display: none;font-size: 30px">{{$wedding->fullnameFemale}}</h2>
                            ...
                            <div class="mb-5 mt-0 p-0" id="family-profil-1" style="display: none">
                                ...
                                <p class="m-0 p-0" style="font-size:18px">{{$wedding->fathernameFemale}}<br> & <br>{{$wedding->mothernameFemale}}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card-body text-center">
                            <h1 class="card-title text-secondary" id="nickname-profil-2" style="display: none;font-size: 40px">{{$wedding->nicknameMale}}</h1>
                            <h2 class="card-subtitle fw-bold" id="fullname-profil-2" style="display: none;font-size: 30px">{{$wedding->fullnameMale}}</h2>
                            <div class="position-relative mb-3">
                            ...
                            <div class="mb-5 mt-0 p-0" id="family-profil-2" style="display:none">
                                ...
                                <p class="m-0 p-0" style="font-size:18px">{{$wedding->fathernameMale}}<br> & <br>{{$wedding->mothernameMale}}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center mt-5 shadow-lg bg-body-tertiary rounded">
                            <a data-fancybox="gallery" href="{{$wedding->photoMale}}">
                                <img id="foto-profil-2" style="display: none" class="card-img-top img-fluid p-3 pb-5" src="{{$wedding->photoMale}}" alt="... " />
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div id="akad-resepsi" class="bg-light">
            <div class="container text-center"> 
                <div class="row">
                        ...
                        <div class="lokasi pb-5" id="weddinglokasidetail1" style="display:none">
                            <div class="card d-inline-flex mt-5" style="width: 100%;background: linear-gradient(to bottom, #FAF9F6, white);">
                                ...
                                <div>
                                    ...
                                    <p style="font-size: 17px" class="m-0 p-0">{{$wedding->solemnizationHourStart}} - {{$wedding->solemnizationHourEnd}} WIB</p>
                        ...
                        <div class="lokasi pb-5 text-center" id="weddinglokasidetail2" style="display:none">
                            ...
                            <div class="card-body shadow-lg p-3 bg-body-tertiary rounded">
                                ...
                                <div>
                                    ...
                                    <p style="font-size: 17px" class="m-0 p-0">{{$wedding->weddingHourStart}} - {{$wedding->weddingHourEnd}} WIB</p>
                    ...
                    <div class="col-md-6">
                        <div class="lokasi pb-5 text-center" id="waktu-tamu-undangan" style="display:none">
                            <div class="card d-inline-flex mt-5" style="width: 100%;background: linear-gradient(to bottom, #FAF9F6, white);" id="weddinglokasidetail2">
                                <div class="card-body shadow-lg p-3 bg-body-tertiary rounded">
                                    <h1 class="card-title fw-bold" style="font-size: 40px">Waktu tamu udangan</h1>
                                    <hr>
                                    <div>
                                        <p style="font-size: 17px" class="m-0 p-0">Rabu</p>
                                        <h2 style="font-size: 25px" class="m-0 p-0">25 Oktober 2023</h2>
                                        <p style="font-size: 17px" class="m-0 p-0">13.00 - 15.00 WIB</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="lokasi pb-5 text-center" id="hiburan-wayang" style="display:none">
                            <div class="card d-inline-flex mt-5" style="width: 100%;background: linear-gradient(to bottom, #FAF9F6, white);" id="weddinglokasidetail2">
                                <div class="card-body shadow-lg p-3 bg-body-tertiary rounded">
                                    <h1 class="card-title fw-bold" style="font-size: 40px">Hiburan Wayang</h1>
                                    <hr>
                                    <div>
                                        <img class="img-fluid" height="100px" width="100px" style="" src="https://i.ibb.co/7XBQt9L/ki-eko.jpg" alt="Dalang Ki Eko" />
                                        <h2 style="font-size: 25px" class="m-0 p-0">Dalang : Ki Eko Prisdiyanto dari Tulungagung</h2>
                                        <img class="img-fluid" height="100px" width="100px" style="" src="https://i.ibb.co/f4bV7FZ/yudho-cs.jpg" alt="Dalang Ki Eko" />
                                        <h2 style="font-size: 25px" class="m-0 p-0">Bintang Tamu : Yudho cs</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="m-0 p-0">
            <div class="text-center bg-light m-0 py-5" id="special-thanks">
                ...
                <h1 style="font-size: 60px;">{{$wedding->nicknameFemale}} & {{$wedding->nicknameMale}}</h1>
    ...
    <script>
        ...
        $(document).scroll(function() {
            ...
            if(y >= 2700){
                ...
                $("#waktu-tamu-undangan").fadeIn(21000);
                $("#hiburan-wayang").fadeIn(28000);
            }
            if(y >= 3400){
                $("#bucket").fadeIn(2500);
