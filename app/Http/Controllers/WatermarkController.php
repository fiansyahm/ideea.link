...
class WatermarkController extends Controller
{
    ...
    public function output(Request $request){
        ...
        $text_image = 'https://w7.pngwing.com/pngs/962/156/png-transparent-do-not-copy-business-copy-document-file-filing-not-office-stamp-watermark.png'; 
        ...
        for($i = 1; $i <= $pagecount; $i++)
        {
            ...
            $watermarkText = $request['text_watermark'];
